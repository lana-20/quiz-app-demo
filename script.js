...
function optionSelected(answer){
    ...
    let allOptions = option_list.children.length;
        ...
        // If the answer is incorrect, automatically select the correct answer
    ...
    //Once the user selects an answer, disable all unselected options
    for (let i = 0; i < allOptions; i++){
...
function showResultBox(){
    ...
    if(userScore > 3){
        let scoreTag = '<span>Congrats! You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p>correct.</span>';
        scoreText.innerHTML = scoreTag;
    }
    else if(userScore > 1){
        let scoreTag = '<span>Nice! You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p>correct.</span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
